...
export default function SearchBlock(props) {
    return (
        <header className={(props.expanded ? 'translate-y-48 md:scale-110 lg:scale-125 xl:scale-150 ' : '') + 'flex flex-col items-center self-start rounded-xl bg-amber-300 text-teal-800 p-3 px-8 md:p-4 md:px-9 lg:p-5 lg:px-10 transition-all duration-500'}>
