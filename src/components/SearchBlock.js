...
export default function SearchBlock(props) {
    return (
        <header className={(props.expanded ? '' : '') + 'flex flex-col items-center rounded-xl bg-amber-300 text-teal-800 p-3 px-8 md:p-4 md:px-9 lg:p-5 lg:px-10 transition-all duration-500'}>
